...
- **Appreciation assets** — the home: what it is worth and the mortgages against it. Each row is tagged worth / owed / other, and the group shows equity, the share of the value it represents, and what has been built this year. Every mortgage row has its own “principal this month” box: entering it comes straight off that balance, and the Home equity line under wealth building is their total (shown there, not typed — tap it to jump here), so the balances, the equity and the year’s build always agree. It carries into each new month and has its own worth / owed / equity chart.
