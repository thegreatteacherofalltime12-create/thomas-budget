...
- **Arrange the trends list** — hold a row for two seconds and it lifts off the list; drag it where you want it. The order is kept with the budget (`settings/app.trendsOrder`), so it follows to any device.
