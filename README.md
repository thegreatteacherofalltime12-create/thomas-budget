...
- **Amount boxes are calculators** — type  or ; totals update as you type, the box shows the result when you leave it, and breakdown items keep the formula as a note (like the sheet did).
