...
- **Trends & balances** — one card on the home page opens a list of every trend window (retained by month, the year outlook, credit-card debt, savings & wealth building, balances); each opens its own overlay with a way back to the list.
